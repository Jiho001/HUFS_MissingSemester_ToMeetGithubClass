...
row_number = int(input('한 페이지에 확인하고싶은 도서의 개수를 입력하세요: '))
...
for page in range(1, page_number + 1):
    ...
    response = requests.get(
        url, params={"vPstrKeyWord": search, 
    ...
    for book in books:
        ...
        author = book.select_one("td.detail > div.author > a:nth-child(1)").string
...
result = pd.read_csv("kyobobook_lv1.csv")
